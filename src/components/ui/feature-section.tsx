              ...
              {features.map(
                (feature, index) =>
                  index === currentFeature && (
                    ...
                    >
                      <div className="w-full h-full bg-gradient-to-br from-neutral-100 to-neutral-200 dark:from-neutral-800 dark:to-neutral-900 flex items-center justify-center rounded-lg">
