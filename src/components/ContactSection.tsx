...
export function ContactSection() {
  ...
  return <section id="contact" ref={ref} className="py-24">
        ...
        duration: 0.8
            ...
            icon: "📧",
            label: "Email",
            value: "alessandro.stella00@gmail.com"
          }, {
            icon: "📱",
            label: "Phone",
          ...
          }].map((contact, index) => <motion.div key={contact.label} initial={{
            opacity: 0,
            y: 30
          }} animate={isInView ? {
            opacity: 1,
            ...
            delay: index * 0.1
                                ...
                                <p className="text-neutral-600 dark:text-neutral-400 text-base">{contact.value}</p>
                            </motion.div>)}
                    </div>
          ...
          delay: 0.4
                        ...
                        <div className="flex justify-center space-x-6 mt-8">
                            {["GitHub", "LinkedIn", "Twitter"].map(social => <motion.a key={social} href="#" whileHover={{
              scale: 1.1
            }} whileTap={{
              scale: 0.9
